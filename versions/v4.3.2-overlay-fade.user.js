...
(function () {
    ...
    function buildCss() {
        return `
        .ar-overlay{position:fixed;inset:0;z-index:2147483646;display:flex;align-items:center;justify-content:center;background:${v('shadowHeavy')};pointer-events:auto;outline:none;transition:background .18s ease-out}
        @media(prefers-reduced-motion:reduce){.ar-overlay{transition-duration:0ms!important}}
    ...
    const Modal = (() => {
        ...
        function _show(id, extra) {
            ...
            if (isSubModal) {
                ...
                if (prevPanel && duration > 0) {
                    top.overlay.style.background = 'transparent';
            ...
            if (!isSubModal) overlay.style.background = 'transparent';
        ...
        function closeAll() {
            ...
            if (topPanel && duration > 0) {
                _transitioning = true;
                topEntry.overlay.style.background = 'transparent';
