...
(function () {
    ...
    function buildCss() {
        return `
        .ar-overlay{position:fixed;inset:0;z-index:2147483646;display:flex;align-items:center;justify-content:center;background:${v('shadowHeavy')};pointer-events:auto;outline:none}
    ...
    const Modal = (() => {
        ...
        function _show(id, extra) {
            ...
            requestAnimationFrame(() => {
                ...
                // Only focus overlay if nothing inside the panel claimed focus during build
