...
(function () {
    ...
    _css.id = 'ar-css';
    _css.textContent = `
        .ar-overlay{position:fixed;inset:0;z-index:2147483646;display:flex;align-items:center;justify-content:center;background:${T.shadowHeavy}}
    ...
    function showToast(message) {
        toastCounter++;
        document.querySelectorAll('.ar-toast').forEach(t => {
